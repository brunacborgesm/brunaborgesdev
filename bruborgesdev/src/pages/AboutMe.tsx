...
export const AboutMe = () => {
    return (
        <div id="about_me" className="h-screen flex flex-col justify-center md:h-full md:mt-20">
            ...
            <div className="flex flex-col items-center gap-14 md:flex-row lg:px-64 md:justify-center">
                <section className="text-center leading-7 text-lg md:text-justify  md:w-1/2">
